...
// import { Container, Content, Footer, Header, Nav } from './styles'
...
//     <>
//     <Header>
//       <p>só vai ter uma imagem e um logo</p>
//     </Header>
//     <Container>
//       <Nav>
//         <p>Vai ter os links</p>
//         <p>home</p>
//         <p>meus posts</p>
//         <p>admin area</p>
//       </Nav>
//       <Content>
//         <p>Uma barra para criação de posts</p>
//         <p>Vai ter a lista de posts com like e dislike</p>
//       </Content>
//     </Container>
//     <Footer>
...
const Main = () => {
  ...
  const handleNewPostSubmit = async (event) => {
    ...
    // Aqui você pode implementar a lógica para enviar o novo post para o backend
    try {
      console.log(newPost)
      const response = await axios.post('/posts/createpost', {
        content: newPost,
        creator_Id: '77aca5b7-62a9-41f9-8973-cae6145a8bae'
      }, {
        headers: {
          'Content-Type': 'application/json',
          // enviar o token aqui tb
        }
      });
  
      console.log('resposta da criacao do post')
      console.log(response)
      if (response.status === 200) {
        const createdPost = response.data.newPostWithUserName        ;
        setPosts((prevPosts) => [...prevPosts, createdPost]);
        setNewPost('');
      } else {
        console.log('Falha ao enviar o novo post');
      }
    } catch (error) {
      console.log('Erro ao enviar o novo post:', error);
    }
  };
  ...
  // Exemplo de dados das postagens
  // const posts = [
  //   { id: 1, text: 'Primeira postagem' },
  //   { id: 2, text: 'Segunda postagem' },
  //   { id: 3, text: 'Terceira postagem' },
  //   { id: 4, text: 'Terceira postagem' },
  //   { id: 5, text: 'Terceira postagem' },
  //   { id: 6, text: 'Terceira postagem' },
  //   { id: 7, text: 'Terceira postagem' },
  // ];
